...
## Education-related questions (MCS)
<!-- - Asked in the  Millenium Cohort Study -->
...
- The [Strengths and Difficulties Questionnaire](https://sdqinfo.org/py/sdqinfo/b3.py?language=Englishqz(UK)) 
...
## Example: Kandola et al (2022){.smaller}
...
## Growing Up in Scotland{.smaller}
...
## Young people and mental health (2){.smaller}


![Probability of scoring SF-12 MCS ≤45.6 indicating clinical depressive disorder by net equivalised household income quintiles.](pics/PLOS.png){fig-alt="Line plot of the probability of scoring SF-12 MCS ≤45.6 indicating clinical depressive disorder by net equivalised household income quintiles." width=80%}
...
- The lesser the conditions for accessing the data, the fewer the details included
...
## Other levels of access{.smaller}
...
## Links & references {.smaller}

- [Administrative Data Research - ADR](https://www.adruk.org)
...
- [UK Longitudinal Linking Collaboration - UKLLC](https://ukllc.ac.uk)
